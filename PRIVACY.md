...
*   **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Power Mode for Command Palette.
...
*   **Website** refers to Power Mode for Command Palette, accessible from [https://gitlab.com/JesterMeijin/power-mode-for-command-palette](https://gitlab.com/JesterMeijin/power-mode-for-command-palette).
...
*   By visiting this page on our website: [https://gitlab.com/JesterMeijin](https://gitlab.com/JesterMeijin)